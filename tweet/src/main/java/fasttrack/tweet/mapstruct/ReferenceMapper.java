...
import fasttrack.tweet.dto.datatype.BaseEntity;
import fasttrack.tweet.dto.datatype.Reference;
import fasttrack.tweet.exception.ReferencedEntityNotFoundException;
...
public class ReferenceMapper {
	...
	public <Entity extends BaseEntity<Id>, Id extends Serializable> Entity toEntity(Reference<Entity, Id> reference,
			@TargetType Class<Entity> entityClass) {
		if (reference != null) {
